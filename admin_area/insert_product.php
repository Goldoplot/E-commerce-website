...
<div class="container mt-3">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="product_title" class="form-control" name="product_title" placeholder="Enter product title" autocomplete="off" required="required">
        </div>
        <!-- description -->
        <div class="form-outline mb-4 w-50 m-auto">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="file" id="product_image2" class="form-control" name="product_image2" required="required">
        </div>

        <!-- Image 3 -->
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="product_image3" class="form-label">Product image 3</label>
            <input type="file" id="product_image3" class="form-control" name="product_image3" required="required">
        </div>
